        ...
        <div class="container">
            <div class="breadcrumb-content">
                <ul>
                    ...
                    {{-- <li>{{$subCategory->first()->category->name}}</li> --}}
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 order-2 order-lg-1">
                    ...
                    <div class="sidebar-categores-box">
                        ...
                        <!-- btn-clear-all start -->
                        <button wire:click="resetFilter" class="btn-clear-all mb-sm-30 mb-xs-30">Clear all</button>
                        <!-- btn-clear-all end -->
                            ...
                            <div class="categori-checkbox">
                                ...
                                <ul>
                                    ...
                                    <li wire:key="{{$brand->name}}">
                                        <input wire:model.live="selectedBrand"
                        ...
                        <div class="filter-sub-area pt-sm-10 pt-xs-10">
                            ...
                            <div class="categori-checkbox">
                                <ul>
                                    ...
                                    <li wire:key="{{$subCat->name}}"><input type="radio" name="brand"
                                            value="{{$subCat->id}}"
                                            wire:model.live='selectedCategory'><a>{{$subCat->name}}</a></li>
                                    @endforeach
