    ...
    <div class="p-4">
        ...
        <div wire:ignore.self>
            ...
            <input type="text"
                ...
                placeholder="Enter Material Name" name="" id="" wire:model.live='name'>
        ...
        <div wire:ignore.self class="mt-3">
            ...
            <textarea name=""
                class="w-full mt-2 rounded-md bg-transparent  dark:text-slate-50 placeholder:dark:text-white"
                placeholder="Enter Description" name="" id="" wire:model.live='description' id="" cols="30"
                rows="3"></textarea>
        ...
        <div class="mt-2" wire:ignore.self>
            <label for="color" class="dark:text-white font-medium pb-2">Price</label>
            <input type="number"
                class="w-full mt-2 rounded-md bg-transparent dark:text-slate-50 placeholder:dark:text-white" name=""
                id="" wire:model.live="price"  placeholder="Enter  Price">
            @error('price')
            <span wire:ignore.self class="text-red-600">{{$message}}</span>
            @enderror
        </div>
        <div class="mt-3" wire:ignore.self>
            <label for="color" class="dark:text-white font-medium pb-2"> Offer Price</label>
            <input type="number"
                class="w-full mt-2 rounded-md bg-transparent dark:text-slate-50 placeholder:dark:text-white" name=""
                id="" wire:model.live="offer_price" placeholder="Enter Offer Price">
            @error('offer_price')
            <span wire:ignore.self class="text-red-600">{{$message}}</span>
            @enderror
        </div>
