                                ...
                                <div class="flex justify-end gap-x-2">
                                    <div>
                                        ...
                                        <button type="button" {{-- wire:click="$dispatch('openDrawer')" --}} {{--
                                            wire:click="addBrand" --}}
                                            wire:click="$dispatch('openDrawer',{event:{component:'add-size',params:{id:1,name:'add-brand'}}})"
                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:bg-bg_dark">
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                                ...
                                <tr class="bg-white hover:bg-gray-50 dark:bg-neutral-900 dark:hover:bg-neutral-800">
                                    ...
                                    <td class="size-px whitespace-nowrap ">
                                        <span
                                            class="px-6 text-indigo-800  dark:text-gray-200 font-medium uppercase text-sm">{{$size->code}}</span>
                                    </td>
                                    <td class="size-px whitespace-nowrap ">
                                        <span
                                            class="px-6 text-indigo-950  dark:text-gray-200 capitalize  text-sm">{{$size->name}}</span>
                                    </td>
                                    ...
                                    <td class="size-px whitespace-nowrap ">
                                        <button
                                            wire:click="$dispatch('openDrawer',{event:{component:'edit-size',params:{id:{{$size->id}}}}})">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
