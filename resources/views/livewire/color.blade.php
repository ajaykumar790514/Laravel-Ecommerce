                                ...
                                <div class="flex justify-end gap-x-2">
                                    <div>
                                        ...
                                        <button type="button" {{-- wire:click="$dispatch('openDrawer')" --}} {{--
                                            wire:click="addBrand" --}}
                                            wire:click="$dispatch('openDrawer',{event:{component:'add-color',params:{id:1,name:'add-brand'}}})"
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                                ...
                                <tr class="bg-white hover:bg-gray-50 dark:bg-neutral-900 dark:hover:bg-neutral-800">
                                    <td class="size-px whitespace-nowrap ">
                                        <span class="px-6 text-indigo-800 font-medium">{{$index+1}}</span>
                                    </td>
                                    
                                    <td class="size-px dark:text-gray-100">
                                        <div style="background-color: {{$color->color}}" class="px-6 h-[25px] rounded-sm w-[100px] border"></div>
                                        
                                    </td>
                                    <td class="size-px whitespace-nowrap ">
                                        <span class="px-6 text-indigo-800  dark:text-gray-200 font-medium text-sm">{{$color->name}}</span>
                                    </td>
                                    ...
                                    <td class="size-px whitespace-nowrap ">
                                        <button
                                            wire:click="$dispatch('openDrawer',{event:{component:'edit-color',params:{id:{{$color->id}}}}})">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
