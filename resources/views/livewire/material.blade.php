                                ...
                                <div class="flex justify-end gap-x-2">
                                    <div>
                                        ...
                                        <button type="button" {{-- wire:click="$dispatch('openDrawer')" --}} {{--
                                            wire:click="addBrand" --}}
                                            wire:click="$dispatch('openDrawer',{event:{component:'add-material',params:{id:1,name:'add-brand'}}})"
                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:bg-bg_dark">
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                                ...
                                <tr class="bg-white hover:bg-gray-50 dark:bg-neutral-900 dark:hover:bg-neutral-800">
                                    <td class=" whitespace-nowrap align-top py-2 ">
                                        <span class="px-6 text-indigo-800 font-medium">{{$material->name}}</span>
                                    </td>


                                    <td class="w-80 py-1" colspan="2">
                                        <span
                                            class=" text-stone-700  dark:text-gray-200  text-sm">{{$material->description}}</span>
                                    </td>
                                    <td class=" whitespace-nowrap align-top py-2">
                                        <span class="px-6 text-gray-800 font-medium">₹ {{$material->price}}</span>
                                    </td><td class=" whitespace-nowrap align-top py-2">
                                        <span class="px-6 text-gray-800 font-medium">₹ {{$material->offer_price}}</span>
                                    </td>
                                    ...
                                    <td class=" whitespace-nowrap align-top py-2 ">
                                        <button
                                            wire:click="$dispatch('openDrawer',{event:{component:'edit-material',params:{id:{{$material->id}}}}})">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
