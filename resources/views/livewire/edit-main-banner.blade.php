<div wire:ingore>
    ...
    <div class="p-4">
        ...
        <div>
            <label for="title" class="dark:text-white font-medium pb-2">Category</label>
            <select class="w-full mt-2 rounded-md bg-transparent  dark:text-slate-50 placeholder:dark:text-white"
                placeholder="Enter Category Name" name="" id="" wire:model.live='category_id'>
        ...
        <div class="mt-3">
            <label for="title" class="dark:text-white font-medium pb-2">Link</label>
            <input type="text"
                class="w-full mt-2 rounded-md bg-transparent  dark:text-slate-50 placeholder:dark:text-white"
                placeholder="Enter Link" name="" id="" wire:model.live='link' />
                @error('link')
                <span class="text-red-600">{{$message}}</span>
                @enderror
        ...
        <div class="mt-2" wire:ignore.self>
            ...
            <select name="" id="" wire:model.live="is_active"
