                ...
                <div class="p-1.5 min-w-full inline-block align-middle">
                    <div
                        ...
                        <div
                            ...
                            <button wire:click="$dispatch('openDrawer',{event:{component:'add-main-banner',params:{}}})"
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                                ...
                                <tr>
                                    ...
                                    <td class=" whitespace-nowrap">
                                        <div class="px-6 ">
                                            <span
                                                class="block text-sm text-gray-900 dark:text-neutral-500">{{$banner->title}}</span>
                                        </div>
                                    </td>
                                    <td class=" whitespace-nowrap">
                                        <div class="px-6 py-3">
                                            <span
                                                class="block text-sm text-gray-500 dark:text-neutral-500">{{$banner->category->name}}</span>
                                    ...
                                    <td class=" whitespace-nowrap">
                                        <div class=" py-3">
                                            ...
                                            @else
                                            <span
                                                class="py-1 px-2 inline-flex capitalize items-center gap-x-1 text-xs font-medium bg-red-100 text-red-900 rounded-md dark:bg-yellow-500/10 dark:text-yellow-500">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                    stroke-width="1.5" stroke="currentColor" class="size-4">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                    ...
                                    <td class=" whitespace-nowrap">
                                        <div class="px-6 ">
                                            <button title="Edit Banner Image"
                                                wire:click="$dispatch('openDrawer',{event:{component:'edit-main-banner',params:{id:{{$banner->id}}}}})">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
